...
export default function Profile({ userName, userImage }: ProfileProps) {
  ...
  return (
    ...
    >
      ...
      {/* 이름 */}
      <span className="text-black hover:text-orange-dark font-medium text-sm leading-6 tracking-normal text-center transition-colors duration-300 whitespace-nowrap">
        {displayName}
      </span>
    </div>
  );
